...
To open an SFTP connection to Mediaflux from Spartan, run

```{bash,eval=F}
sftp -P 22 unimelb:${USER}@mediaflux.researchsoftware.unimelb.edu.au
```
...
-   The SFTP flag `-a` will attempt to resume an interrupted transfer by (e.g.) completing partially-complete file transfers and ignoring already-transferred files.
