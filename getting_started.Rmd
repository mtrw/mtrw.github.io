...
10. Set up some common directories
    ...
    - If you use R, it's good to have somewhere to store all your packages. Note the dot at the beginning -- this makes the directory hidden.
...
5. What now?
    - If you haven't already, it's time to learn some Linux!
        - [Basics](https://www.youtube.com/watch?v=oxuRxtrO2Ag)
        - [More advanced features and shell scripting](https://www.youtube.com/watch?v=emhouufDnB4), or (a bit more gently) [here](https://www.youtube.com/playlist?list=PLT98CRl2KxKGj-VKtApD8-zCqSaN2mD4w)
        - [Zsh](https://zsh.sourceforge.io/Intro/intro_1.html)
    - Once you're comfortable with that, either learn to [run jobs on the Spartan](./tutorial_slurm_shellscripts.html), or read on to get set up with R.
